...
import { ArrowLeft, Building2, Clock, DollarSign, MapPin, Users } from 'lucide-react';
            ...
            <div className='mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6'>
                ...
                <div className=''>
                    ...
                    <div className='relative bg-white px-0 pb-8 mt-8 border-b border-gray-100'>
                        <div className='relative z-10'>
                            ...
                            <div className='flex flex-wrap gap-3 mt-6 md:mt-0'>
                                <span className='px-4 py-2 bg-blue-50 text-sm text-teal-700 font-semibold rounded-full border border-teal-200'>
                                    {
                    ...
                    <div className='px-0 pb-8 space-y-8'>
                        {/* Salary Section */}
                        <div className='relative overflow-hidden bg-gradient-to-r from from-emerald-50 to-teal-50 border-emerald-100 p-6 rounded-2xl'>
                            ...
                            <div className='relative z-10'>
                                <div className='flex items-center justify-between'>
                                    <div className='flex items-center space-x-3'>
                                        <div className='p-3 bg-gradient-to-r from bg-emerald-500 to-teal-500 rounded-xl'>
